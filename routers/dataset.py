...
@router.get("/datasets/", status_code=200, response_model=list[dataset_schema.Dataset])
...
@router.post("/datasets/", status_code=201,response_model=dataset_schema.Dataset)

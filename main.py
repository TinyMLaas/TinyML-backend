...
from routers import compiled_model, device, bridge, dataset, model, installer, observation
...
app.include_router(installer.router, tags=["Installers"])

app.include_router(observation.router, tags=["Observing"])
